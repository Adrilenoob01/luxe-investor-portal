      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="bg-card p-8 rounded-lg shadow-lg border border-border">
          <p className="text-lg text-muted-foreground mb-6">
            Chers investisseurs, <BR>C’est avec une grande tristesse que nous vous annonçons la suspension immédiate des
            activités de WearShop. <BR>En effet, l’un de nos colis a récemment été saisi par les services de douane dans le
            ...
            l’assurance, etc.). <BR>En conséquence, tous les versements sont temporairement suspendus, dans l’attente d’un
            ...
            situation dans les meilleurs délais.<BR>Nous vous remercions sincèrement pour votre patience, votre
            ...
            informés de la suite des événements. <BR>Avec tout notre respect et notre gratitude, <BR>L’équipe WearShop</p>
          </p>
